...
| T2 | Larger disaster shock only (flag already Yes) | `G21`,`H21` | 10 → **20** | C2 | — |
...
| T6 | Commodity price shock more severe | `G46`,`H46` | ≈ −0.23 → **−0.40** | C3 | `more_severe_commodity_price` |
...
| R3 | Higher residual external interest | `E14` | ≈8.0% → **12%** (write decimal **0.12**) | PV of residual PPG | `higher_resfin_external_interest` |
| R4 | Longer residual maturity | `E16` | 9 → **12** years | Grant element / PV | — |
| R5 | Higher discount rate | `E15` | 5% → **7%** | Residual PV | — |
...
Still open for later single-story cases: R4, R5; optional public mirrors (`output_32`) of GDP/PB/market-access as **separate** case ids.
