"""Concrete ``MacroShock`` adapters over ``shocks.macro`` helpers."""
...
import lic_dsf.stress.shocks.macro as _macro_shocks
...
class MacroShockFactory:
    ...
    def from_spec(cls, spec: ScenarioSpec) -> object:
        ...
        if adapter is None:
            from lic_dsf.stress.shocks.tailored import TAILORED_SHOCKS
