...
Stress GFN / path types are imported lazily inside
:meth:`ResidualFinancingEngine.solve_public_with_gfn_feedback` so ``resfin``
does not depend on ``stress`` at import time.
"""
...
from lic_dsf.resfin.types import PublicResFinOverlay, ResFinOverlay, ResidualFill
...
class ResidualFinancingEngine:
    ...
    def solve_public_with_gfn_feedback(
        ...
        *,
        ...
        from lic_dsf.stress.public_gfn import PublicGFNIdentity, _inflation_elasticity
