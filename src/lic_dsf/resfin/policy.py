...
from lic_dsf.resfin.overlay import split_residual_financing
from lic_dsf.resfin.params import ResidualFinancingParams
from lic_dsf.resfin.types import ResidualFill


class ResidualPolicyKind(str, Enum):
    """ResFin split policy marker for :func:`policy_from_kind`."""
