...
| `load_macro_debt_inputs` (`lic_dsf.load`) | Input 3 / Macro blocks from the workbook |
...
[`demo/macro_debt.ipynb`](https://github.com/Teal-Insights/py-lic-dsf/blob/main/demo/macro_debt.ipynb)
