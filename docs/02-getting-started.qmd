...
Demos and tests use the macros-stripped template: `data/lic-dsf-template-2025-08-12.xlsx`
...
`include_zero_disbursement=True` keeps empty Input 4/5 slots so creditor grouping matches Excel row structure.

## Next steps

| Goal | Doc | Demo |
|------|-----|------|
| Inspect Ext headlines / PV | [ext-debt-module-design.qmd](ext-debt-module-design.qmd) | `demo/ext_debt.ipynb` |
| Stress paths (Input 6) | [stress-dsa.qmd](stress-dsa.qmd) | `demo/stress_dsa.ipynb` |
| Mechanical risk rating | [risk-rating.qmd](risk-rating.qmd) | `demo/risk_rating.ipynb` |
| All Outputs in one place | [excel-map.qmd](excel-map.qmd) | `demo/all_outputs.ipynb` |

Quick stress sketch after the books above:

```python
from lic_dsf.load import load_input6_standard, load_input7_residual_params
